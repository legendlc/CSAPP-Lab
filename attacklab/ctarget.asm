...
0000000000400ebc <call_gmon_start>:
  ...
  400ec0:	48 8b 05 19 31 20 00 	mov    rax,QWORD PTR [rip+0x203119]        # 603fe0 <_DYNAMIC+0x1d0>
...
0000000000402ce0 <__libc_csu_init>:
  ...
  402cea:	48 8d 2d 0f 11 20 00 	lea    rbp,[rip+0x20110f]        # 603e00 <__init_array_end>
