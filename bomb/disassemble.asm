...
0000000000400cbc <call_gmon_start>:
  ...
  400cc0:	48 8b 05 19 23 20 00 	mov    rax,QWORD PTR [rip+0x202319]        # 602fe0 <_DYNAMIC+0x1d0>
...
00000000004012a0 <sig_handler>:
  ...
  4012cc:	48 8b 3d 6d 24 20 00 	mov    rdi,QWORD PTR [rip+0x20246d]        # 603740 <__bss_start>
...
0000000000402210 <__libc_csu_init>:
  ...
  40221a:	48 8d 2d df 0b 20 00 	lea    rbp,[rip+0x200bdf]        # 602e00 <__init_array_end>
