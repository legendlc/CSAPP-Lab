...
0000000000400c70 <strcasecmp@plt>:
  400c70:	ff 25 8a 43 20 00    	jmp    QWORD PTR [rip+0x20438a]        # 605000 <_GLOBAL_OFFSET_TABLE_+0x18>
  400c76:	68 00 00 00 00       	push   0x0
  400c7b:	e9 e0 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400c80 <__errno_location@plt>:
  400c80:	ff 25 82 43 20 00    	jmp    QWORD PTR [rip+0x204382]        # 605008 <_GLOBAL_OFFSET_TABLE_+0x20>
  400c86:	68 01 00 00 00       	push   0x1
  400c8b:	e9 d0 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400c90 <srandom@plt>:
  400c90:	ff 25 7a 43 20 00    	jmp    QWORD PTR [rip+0x20437a]        # 605010 <_GLOBAL_OFFSET_TABLE_+0x28>
  400c96:	68 02 00 00 00       	push   0x2
  400c9b:	e9 c0 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400ca0 <strncmp@plt>:
  400ca0:	ff 25 72 43 20 00    	jmp    QWORD PTR [rip+0x204372]        # 605018 <_GLOBAL_OFFSET_TABLE_+0x30>
  400ca6:	68 03 00 00 00       	push   0x3
  400cab:	e9 b0 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400cb0 <strcpy@plt>:
  400cb0:	ff 25 6a 43 20 00    	jmp    QWORD PTR [rip+0x20436a]        # 605020 <_GLOBAL_OFFSET_TABLE_+0x38>
  400cb6:	68 04 00 00 00       	push   0x4
  400cbb:	e9 a0 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400cc0 <puts@plt>:
  400cc0:	ff 25 62 43 20 00    	jmp    QWORD PTR [rip+0x204362]        # 605028 <_GLOBAL_OFFSET_TABLE_+0x40>
  400cc6:	68 05 00 00 00       	push   0x5
  400ccb:	e9 90 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400cd0 <write@plt>:
  400cd0:	ff 25 5a 43 20 00    	jmp    QWORD PTR [rip+0x20435a]        # 605030 <_GLOBAL_OFFSET_TABLE_+0x48>
  400cd6:	68 06 00 00 00       	push   0x6
  400cdb:	e9 80 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400ce0 <__stack_chk_fail@plt>:
  400ce0:	ff 25 52 43 20 00    	jmp    QWORD PTR [rip+0x204352]        # 605038 <_GLOBAL_OFFSET_TABLE_+0x50>
  400ce6:	68 07 00 00 00       	push   0x7
  400ceb:	e9 70 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400cf0 <mmap@plt>:
  400cf0:	ff 25 4a 43 20 00    	jmp    QWORD PTR [rip+0x20434a]        # 605040 <_GLOBAL_OFFSET_TABLE_+0x58>
  400cf6:	68 08 00 00 00       	push   0x8
  400cfb:	e9 60 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d00 <memset@plt>:
  400d00:	ff 25 42 43 20 00    	jmp    QWORD PTR [rip+0x204342]        # 605048 <_GLOBAL_OFFSET_TABLE_+0x60>
  400d06:	68 09 00 00 00       	push   0x9
  400d0b:	e9 50 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d10 <alarm@plt>:
  400d10:	ff 25 3a 43 20 00    	jmp    QWORD PTR [rip+0x20433a]        # 605050 <_GLOBAL_OFFSET_TABLE_+0x68>
  400d16:	68 0a 00 00 00       	push   0xa
  400d1b:	e9 40 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d20 <close@plt>:
  400d20:	ff 25 32 43 20 00    	jmp    QWORD PTR [rip+0x204332]        # 605058 <_GLOBAL_OFFSET_TABLE_+0x70>
  400d26:	68 0b 00 00 00       	push   0xb
  400d2b:	e9 30 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d30 <read@plt>:
  400d30:	ff 25 2a 43 20 00    	jmp    QWORD PTR [rip+0x20432a]        # 605060 <_GLOBAL_OFFSET_TABLE_+0x78>
  400d36:	68 0c 00 00 00       	push   0xc
  400d3b:	e9 20 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d40 <__libc_start_main@plt>:
  400d40:	ff 25 22 43 20 00    	jmp    QWORD PTR [rip+0x204322]        # 605068 <_GLOBAL_OFFSET_TABLE_+0x80>
  400d46:	68 0d 00 00 00       	push   0xd
  400d4b:	e9 10 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d50 <signal@plt>:
  400d50:	ff 25 1a 43 20 00    	jmp    QWORD PTR [rip+0x20431a]        # 605070 <_GLOBAL_OFFSET_TABLE_+0x88>
  400d56:	68 0e 00 00 00       	push   0xe
  400d5b:	e9 00 ff ff ff       	jmp    400c60 <_init+0x18>

0000000000400d60 <gethostbyname@plt>:
  400d60:	ff 25 12 43 20 00    	jmp    QWORD PTR [rip+0x204312]        # 605078 <_GLOBAL_OFFSET_TABLE_+0x90>
  400d66:	68 0f 00 00 00       	push   0xf
  400d6b:	e9 f0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400d70 <__memmove_chk@plt>:
  400d70:	ff 25 0a 43 20 00    	jmp    QWORD PTR [rip+0x20430a]        # 605080 <_GLOBAL_OFFSET_TABLE_+0x98>
  400d76:	68 10 00 00 00       	push   0x10
  400d7b:	e9 e0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400d80 <strtol@plt>:
  400d80:	ff 25 02 43 20 00    	jmp    QWORD PTR [rip+0x204302]        # 605088 <_GLOBAL_OFFSET_TABLE_+0xa0>
  400d86:	68 11 00 00 00       	push   0x11
  400d8b:	e9 d0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400d90 <memcpy@plt>:
  400d90:	ff 25 fa 42 20 00    	jmp    QWORD PTR [rip+0x2042fa]        # 605090 <_GLOBAL_OFFSET_TABLE_+0xa8>
  400d96:	68 12 00 00 00       	push   0x12
  400d9b:	e9 c0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400da0 <time@plt>:
  400da0:	ff 25 f2 42 20 00    	jmp    QWORD PTR [rip+0x2042f2]        # 605098 <_GLOBAL_OFFSET_TABLE_+0xb0>
  400da6:	68 13 00 00 00       	push   0x13
  400dab:	e9 b0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400db0 <random@plt>:
  400db0:	ff 25 ea 42 20 00    	jmp    QWORD PTR [rip+0x2042ea]        # 6050a0 <_GLOBAL_OFFSET_TABLE_+0xb8>
  400db6:	68 14 00 00 00       	push   0x14
  400dbb:	e9 a0 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400dc0 <_IO_getc@plt>:
  400dc0:	ff 25 e2 42 20 00    	jmp    QWORD PTR [rip+0x2042e2]        # 6050a8 <_GLOBAL_OFFSET_TABLE_+0xc0>
  400dc6:	68 15 00 00 00       	push   0x15
  400dcb:	e9 90 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400dd0 <__isoc99_sscanf@plt>:
  400dd0:	ff 25 da 42 20 00    	jmp    QWORD PTR [rip+0x2042da]        # 6050b0 <_GLOBAL_OFFSET_TABLE_+0xc8>
  400dd6:	68 16 00 00 00       	push   0x16
  400ddb:	e9 80 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400de0 <munmap@plt>:
  400de0:	ff 25 d2 42 20 00    	jmp    QWORD PTR [rip+0x2042d2]        # 6050b8 <_GLOBAL_OFFSET_TABLE_+0xd0>
  400de6:	68 17 00 00 00       	push   0x17
  400deb:	e9 70 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400df0 <__printf_chk@plt>:
  400df0:	ff 25 ca 42 20 00    	jmp    QWORD PTR [rip+0x2042ca]        # 6050c0 <_GLOBAL_OFFSET_TABLE_+0xd8>
  400df6:	68 18 00 00 00       	push   0x18
  400dfb:	e9 60 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e00 <fopen@plt>:
  400e00:	ff 25 c2 42 20 00    	jmp    QWORD PTR [rip+0x2042c2]        # 6050c8 <_GLOBAL_OFFSET_TABLE_+0xe0>
  400e06:	68 19 00 00 00       	push   0x19
  400e0b:	e9 50 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e10 <getopt@plt>:
  400e10:	ff 25 ba 42 20 00    	jmp    QWORD PTR [rip+0x2042ba]        # 6050d0 <_GLOBAL_OFFSET_TABLE_+0xe8>
  400e16:	68 1a 00 00 00       	push   0x1a
  400e1b:	e9 40 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e20 <strtoul@plt>:
  400e20:	ff 25 b2 42 20 00    	jmp    QWORD PTR [rip+0x2042b2]        # 6050d8 <_GLOBAL_OFFSET_TABLE_+0xf0>
  400e26:	68 1b 00 00 00       	push   0x1b
  400e2b:	e9 30 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e30 <gethostname@plt>:
  400e30:	ff 25 aa 42 20 00    	jmp    QWORD PTR [rip+0x2042aa]        # 6050e0 <_GLOBAL_OFFSET_TABLE_+0xf8>
  400e36:	68 1c 00 00 00       	push   0x1c
  400e3b:	e9 20 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e40 <exit@plt>:
  400e40:	ff 25 a2 42 20 00    	jmp    QWORD PTR [rip+0x2042a2]        # 6050e8 <_GLOBAL_OFFSET_TABLE_+0x100>
  400e46:	68 1d 00 00 00       	push   0x1d
  400e4b:	e9 10 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e50 <connect@plt>:
  400e50:	ff 25 9a 42 20 00    	jmp    QWORD PTR [rip+0x20429a]        # 6050f0 <_GLOBAL_OFFSET_TABLE_+0x108>
  400e56:	68 1e 00 00 00       	push   0x1e
  400e5b:	e9 00 fe ff ff       	jmp    400c60 <_init+0x18>

0000000000400e60 <__fprintf_chk@plt>:
  400e60:	ff 25 92 42 20 00    	jmp    QWORD PTR [rip+0x204292]        # 6050f8 <_GLOBAL_OFFSET_TABLE_+0x110>
  400e66:	68 1f 00 00 00       	push   0x1f
  400e6b:	e9 f0 fd ff ff       	jmp    400c60 <_init+0x18>

0000000000400e70 <__sprintf_chk@plt>:
  400e70:	ff 25 8a 42 20 00    	jmp    QWORD PTR [rip+0x20428a]        # 605100 <_GLOBAL_OFFSET_TABLE_+0x118>
  400e76:	68 20 00 00 00       	push   0x20
  400e7b:	e9 e0 fd ff ff       	jmp    400c60 <_init+0x18>

0000000000400e80 <socket@plt>:
  400e80:	ff 25 82 42 20 00    	jmp    QWORD PTR [rip+0x204282]        # 605108 <_GLOBAL_OFFSET_TABLE_+0x120>
  400e86:	68 21 00 00 00       	push   0x21
  400e8b:	e9 d0 fd ff ff       	jmp    400c60 <_init+0x18>
...
0000000000400ebc <call_gmon_start>:
  ...
  400ec0:	48 8b 05 19 41 20 00 	mov    rax,QWORD PTR [rip+0x204119]        # 604fe0 <_DYNAMIC+0x1d0>
...
0000000000402e00 <__libc_csu_init>:
  ...
  402e0a:	48 8d 2d ef 1f 20 00 	lea    rbp,[rip+0x201fef]        # 604e00 <__init_array_end>
